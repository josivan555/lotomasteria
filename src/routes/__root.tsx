...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Análise estatística inteligente do histórico completo da Lotofácil: frequência, atraso, tendência, score IA e geração de jogos com filtros avançados." },
      { property: "og:title", content: "LotoMaster IA — Análise inteligente para Lotofácil" },
      { property: "og:description", content: "Análise estatística inteligente do histórico completo da Lotofácil: frequência, atraso, tendência, score IA e geração de jogos com filtros avançados." },
...
function RootComponent() {
  ...
  useEffect(() => {
    // Filter to identity transitions; refetch only when a session exists.
